...
// sets the template for config package
...
func RenderTemplate(w http.ResponseWriter, tmpl string, td *models.TemplateData) {
	...
	// Handle prod mode and dev mode
	// Rebuild templates for every request in dev mode
	// Cache the templates and use the same in prod mode
	if app.UseCache {
